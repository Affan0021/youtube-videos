...
class Apocaly extends StatefulWidget {

  @override
  ApocalyState createState() => ApocalyState();
}

class ApocalyState extends State< Apocaly> {


  YoutubePlayerController _controller = YoutubePlayerController(
      initialVideoId: 'sElE_BfQ67s',
              ...
              //      Column(
                children: [
                  ...
                  Container(
                    ...
                    child:  const Text(
                      'Apocalypse - Cigrettes after sex from cigrettes after sex (official)',
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'OpenSans',
                        fontSize: 20.0,
                  ...
                  ListTile(
                    ...
                    leading:  const CircleAvatar(
                      backgroundImage: AssetImage('user/dp.jpeg'),
                    ),
                    title: const Text(
                      'CigrettesAfterSex',
                      style: TextStyle(
                    ...
                    //alignment: Alignment.center,
                      ...
                      decoration:   BoxDecoration(
                        ...
                        image:  const DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('user/pic2.jpg'),
