...
class Darkhast extends StatefulWidget {

  @override
  DarkhastState createState() => DarkhastState();
}

class DarkhastState extends State< Darkhast> {


  YoutubePlayerController _controller = YoutubePlayerController(
      initialVideoId: 'GNm7vIZXEYw',
              ...
              //      Column(
                children: [
                  ...
                  Container(
                    ...
                    child:  const Text(
                      'Darkhawaast - (Slowed and Reverb) | Arijit Singh tu meri baho main (official)',
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'OpenSans',
                        fontSize: 20.0,
                  ...
                  ListTile(
                    ...
                    leading:  const CircleAvatar(
                      backgroundImage: AssetImage('user/22.jpg'),
                    ),
                    title: const Text(
                      'Desi Slowed & Reverb',
                      style: TextStyle(
                  ...
                  ListTile(
                    ...
                    title: const Text(
                      'This is my favourate song from all Romantic songs. Very Relaxing....',
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'OpenSans',
                        fontSize: 15.0,
                    ...
                    //alignment: Alignment.center,
                      ...
                      decoration:   BoxDecoration(
                        ...
                        image:  const DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('user/pic1.jpg'),
